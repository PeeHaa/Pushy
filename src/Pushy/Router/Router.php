...
class Router implements Routable
{
    ...
    /**
     * @var \Pushy\Router\RouteBuilder Instance of a route builder
     */
     ...
     * Creates instance
     *
     * @param \Pushy\Router\RouteBuilder $routeFactory Instance of a route builder
     */
